...
class calendarPage {
  ...
  addHandlerEvent(dateMonth) {
    ...
    document
      .querySelector("table")
      .addEventListener("dblclick", (event) => this.renderMadal(event));
    document
      .querySelector("table")
      .addEventListener("click", (event) => this.delCaption(event));
  }
...
delCaption(e) {
  ...
  let dataBase = this.db; //создание экземпляра класса базы данных
